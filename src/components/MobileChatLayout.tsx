...
import { logo_with_name, png_logo } from "../../public/images/images";
  ...
  return (
    <div className="fixed bg-gradient-to-b from-white to-emerald-100/40 border-b border-zinc-200 top-0 inset-x-0 py-6 px-4 ">
      <div className="w-full flex justify-between items-center ">
        ...
        >
          <Image src={logo_with_name} width={90} alt="guff logo" />
        </Link>
        <Button onClick={() => setOpen(true)} className="gap-4 bg-emerald-700">
